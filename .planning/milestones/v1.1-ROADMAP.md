...
**Active Milestone:** M007-ext / M008 / M009 / M010 — DONE; M007 M005 Follow-ups (v1.1) DONE
...
## M007: M005 Follow-ups — DONE (v1.1)
...
**Status:** DONE (v1.1, completed procedurally 2026-06-24)
**Branch:** TBD
**Phase dir:** `.planning/phases/{15,16,17}-*/`

**Phase Tracking:**

- [x] Phase 15: M005 OCI Snapshots
- [x] Phase 16: M005 Cloudflare Access
- [x] Phase 17: M005 Observability + RWX
...
### Phase 15: M005 OCI Snapshots ✅ DONE

**Goal:** Workflow versionado de snapshots OCI para SRV-1/2/3 com rollback formal, IDs rastreáveis e restore drill validado.

**Status (2026-06-24):** COMPLETE procedurally. CLI shipped + dry-run validado nos 4 hosts oracle-oci; live OCI segue como gate operacional externo (sem `oci` CLI + `~/.oci/config`). Ver `15-SUMMARY.md` + `docs/operations/oci-snapshots.md`.
...
### Phase 16: M005 Cloudflare Access ✅ DONE
...
**Status (2026-06-24):** COMPLETE procedurally. Code shipped; live cutover segue bloqueado no dashboard.
...
### Phase 17: M005 Observability + RWX ✅ DONE
...
**Status (2026-06-24):** COMPLETE procedurally. Code/artifacts shipped; live closeout segue como gate operacional externo.
