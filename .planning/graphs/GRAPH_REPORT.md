...
## Corpus Check
- 1006 files · ~1,901,941 words
- Verdict: corpus is large enough that graph structure adds value.

## Summary
- 12641 nodes · 17640 edges · 1082 communities (932 shown, 150 thin omitted)
- Extraction: 99% EXTRACTED · 1% INFERRED · 0% AMBIGUOUS · INFERRED: 181 edges (avg confidence: 0.8)
- Token cost: 0 input · 0 output

## Graph Freshness
- Built from commit: `63c0c40d`
...
1. `Communities (1085 total, 150 thin omitted)` - 914 edges
2. `_write_evidence()` - 63 edges
3. `Roadmap: Omni Srv Admin (omni-srv-admin)` - 55 edges
4. `Blocked` - 53 edges
5. `contract()` - 52 edges
6. `_edge_applier_module()` - 52 edges
7. `Phase52BackupBTests` - 46 edges
8. `_assert_blocked()` - 44 edges
9. `State: Omni Srv Admin (omni-srv-admin)` - 41 edges
10. `run_preflight()` - 40 edges

## Surprising Connections (you probably didn't know these)
- `deploy_list()` --calls--> `list_projects()`  [INFERRED]
  cli/omni/cli.py → modules/fork-sync/cli/fork_sync/core/registry.py
- `_call()` --calls--> `Runner`  [INFERRED]
  cli/omni/fleet_collectors.py → modules/rustdesk-fleet/tools/install-phase53-server.py
- `_safe_git()` --calls--> `Runner`  [INFERRED]
  cli/omni/fleet_versioning.py → modules/rustdesk-fleet/tools/install-phase53-server.py
- `apply_omni_self_update()` --calls--> `_write()`  [INFERRED]
  cli/omni/fleet_versioning.py → modules/fork-sync/cli/tests/test_release_preflight.py
...
- 1-file cycle: `modules/fleet-control-plane/scripts/phase54_network_gate.py -> modules/fleet-control-plane/scripts/phase54_network_gate.py`
- 1-file cycle: `modules/rustdesk-fleet/tests/test_phase53_primary_edge.py -> modules/rustdesk-fleet/tests/test_phase53_primary_edge.py`
- 1-file cycle: `modules/rustdesk-fleet/tools/apply-phase53-edge.py -> modules/rustdesk-fleet/tools/apply-phase53-edge.py`
...
## Communities (1082 total, 150 thin omitted)

### Community 0 - "Community 0"
Cohesion: 0.00
Nodes (914): Communities (1085 total, 150 thin omitted), Community 0 - "Community 0", Community 1001 - "Community 1001", Community 1002 - "Community 1002", Community 1003 - "Community 1003", Community 1004 - "Community 1004", Community 1005 - "Community 1005", Community 1006 - "Community 1006" (+906 more)
...
Cohesion: 0.10
Nodes (34): CompletedProcess, Path, autoclean(), _autoclean_script(), _find_host(), _host_ids_for_arg(), _list_hosts(), list_servers() (+26 more)
...
Cohesion: 0.05
Nodes (59): Any, Path, _copy_resource_units(), _docker_build_warning(), _host_cpu_count(), _install_resource_units(), _is_risky_command(), list_ops() (+51 more)
...
Cohesion: 0.11
Nodes (31): inviolable-watchdog.sh script, atius_pm2_stack_ok(), atius_router_containers_ok(), atius_router_docs_ok(), atius_web_healthcheck_ok(), atius_web_ok(), guarded_relaunch(), hermes_telegram_ok() (+23 more)

### Community 14 - "Community 14"
Cohesion: 0.13
Nodes (32): Path, apply_profile_limits(), bandwidth_to_cgroup(), cgroup_device(), classify(), cpu_quota_to_cgroup(), ensure_omni_cgroups_exist(), ensure_slices_active() (+24 more)
...
Cohesion: 0.13
Nodes (34): Path, _apply_xrdp_overrides(), _backup_current(), _check_files_exist(), _command_exists(), _copy_if_exists(), diff_cmd(), _ensure_packages() (+26 more)
...
Cohesion: 0.06
Nodes (37): admin(), admin_health(), admin_processes(), admin_status(), backup(), backup_create(), backup_list(), backup_restore() (+29 more)

### Community 40 - "Community 40"
Cohesion: 0.07
Nodes (28): 10. Changelog, 1. Identidade dos Hosts, 2. Topologia de Rede, 3. Mapa de IPs (canônico), 4. Convenção de Displays / VNC / noVNC, 5. Inventário de Portas (canônico, estado 2026-07-05), 6. Portas Reservadas (ranges por categoria), 7.1 Adicionar slot camofox (ex: slot 2 no display :16) (+20 more)

### Community 41 - "Community 41"
Cohesion: 0.07
Nodes (82): ABC, BaseException, Any, Path, Popen, _acquire_lock(), atomic_json(), Blocked (+74 more)
...
Cohesion: 0.21
Nodes (22): Path, _cfg(), _clone(), _commit_file(), _git(), _init_repo(), repo_pair(), test_diagnose_container_mirrors_detects_invalid_git_copy() (+14 more)
...
Cohesion: 0.09
Nodes (55): Any, datetime, Namespace, Path, _active_nft_source(), AddressBarrier, apply_host_policy(), audit_effective_oci_ingress() (+47 more)
...
Cohesion: 0.31
Nodes (17): Path, effective_cpu_quota(), load_config(), main(), normalize_latest_perf(), print_direct_cgroups(), print_hot_build_escapes(), print_hygiene_health() (+9 more)

### Community 110 - "Community 110"
Cohesion: 0.16
Nodes (14): apply(), drift(), podman_network(), podman-network — fleet-wide podman networking standard CLI.  Subcommands:   drif, Run a script from the module's scripts/ dir., Fleet-wide podman networking standard (containers.conf + netavark + aardvark)., Show podman networking drift across all 3 SRVs (comparison table)., Apply the podman networking standard to one SRV (N=1, 2, or 3).      Idempotent. (+6 more)
...
Cohesion: 0.33
Nodes (15): Any, Path, acquire_audit_lock(), atomic_write(), build_report(), dir_size(), fixed_sizes(), gib() (+7 more)
...
Cohesion: 0.21
Nodes (21): Path, classify_kind(), ensure_cap75_cgroup(), ensure_guard_services(), get_cgroup(), get_cmdline(), get_comm(), get_cpu_jiffies() (+13 more)
...
Cohesion: 0.18
Nodes (10): Community Hubs (Navigation), Corpus Check, God Nodes (most connected - your core abstractions), Graph Freshness, Graph Report - _omni-srv-admin-phase54-replan-20260724  (2026-07-26), Import Cycles, Knowledge Gaps, Suggested Questions (+2 more)
...
Cohesion: 0.18
Nodes (11): REPL interativo (estilo CLI-Anything).  Comandos disponíveis no REPL (sem o pref, Tenta importar prompt_toolkit; cai de volta para input() se não tiver., Loop principal do REPL., run_repl(), _try_prompt_toolkit(), cli(), main(), fork-sync — gestão unificada de forks (sync, deploy, versionamento). (+3 more)
...
Cohesion: 0.20
Nodes (9): resource-governor-cgroup-init.sh script, cpu_quota_to_cg(), get(), load_env(), profile_cpu_quota_to_cg(), quote(), user_systemd_env(), write_cg() (+1 more)
...
Cohesion: 0.10
Nodes (52): Any, CompletedProcess, Path, _apt_policy(), _apt_program_status(), _apt_sources_text(), _config_status(), config_verify() (+44 more)
...
Cohesion: 0.25
Nodes (6): build-cpu-guard-wrapper.sh script, inside_build_cgroup(), is_build_command(), load_host_cpu_quota(), OMNI_BUILD_CPU_GUARD_ACTIVE, user_systemd_env()
...
Cohesion: 0.54
Nodes (7): sync-vault.sh script, auto_commit_changes(), notify_telegram(), record_gbrain_sync_failure(), record_gbrain_sync_success(), sync_gbrain_index(), validate_vault_layout()
...
Cohesion: 0.32
Nodes (6): install-fleet-backup.sh script, HOME_DIR, install_phase52_horistic(), PHASE52_STATE_HELPER, PHASE52_STATE_ROOT, usage()
...
Cohesion: 0.50
Nodes (4): .planning/graphs/manifest.json, ast_hash, mtime, semantic_hash
...
Cohesion: 0.13
Nodes (33): Path, agent_collect_programs(), agent_collect_version(), agent_cycle(), agent_heartbeat(), agent_loop(), agent_once(), agent_self_update_runner() (+25 more)

### Community 525 - "Community 525"
Cohesion: 0.08
Nodes (48): Any, _app_payload(), _fork_payload(), heartbeat(), _heartbeat_payload(), _host_apps(), _host_database_contract(), _host_forks() (+40 more)
...
Cohesion: 0.14
Nodes (40): Any, datetime, Namespace, Path, _action_to_dict(), _append_audit_event(), _build_repair_report(), _build_summary() (+32 more)

### Community 537 - "Community 537"
Cohesion: 0.10
Nodes (43): _db_env(), _emit(), landscape_parity(), _load_pki_host(), _now(), _pki_inventory_host_ids(), _pki_render_host(), profiles_managed_apps() (+35 more)

### Community 538 - "Community 538"
Cohesion: 0.22
Nodes (17): Any, CollectorRunner, Path, Path, apply_omni_self_update(), collect_omni_version(), _default_backup_root(), load_omni_version_matrix() (+9 more)
...
Cohesion: 0.08
Nodes (15): Path, _assert_unit_is_read_only_unit(), _extract_execstart_commands(), _index(), _make_pm2_app(), Tests for production guard baseline, parity checks and CLI wiring., _read_unit_file(), test_ecosystem_validator_checks_contract_and_redacts_secrets() (+7 more)
...
Cohesion: 0.08
Nodes (49): Any, _access_key(), activities_group(), activities_recent(), activities_show(), api(), _canonical_query(), computers() (+41 more)
...
Cohesion: 0.21
Nodes (24): Any, CollectorRunner, _call(), _collect_cargo(), _collect_containers(), _collect_dpkg(), _collect_json_package_list(), _collect_npm() (+16 more)
...
Cohesion: 0.07
Nodes (56): security(), agent(), audit(), _cert_sans_from_file(), Entry point: python -m omni.fleet_entry, fleet(), _host_aliases(), _host_inventory_payload() (+48 more)
...
Cohesion: 0.40
Nodes (4): Any, Path, load_managed_apps_profile(), Desired-state profile helpers for Omni Fleet governance.
...
Cohesion: 0.40
Nodes (4): managed_hosts, namespace, schema_version, scripts
...
Cohesion: 0.83
Nodes (3): version-report.sh script, pm2_version_readonly(), report()
...
Cohesion: 0.23
Nodes (20): _command_template(), _finish_plan_db(), _json_literal(), _load_db_host(), _psql(), _psql_json(), queue_self_update(), queue_update() (+12 more)
...
Cohesion: 0.30
Nodes (14): sso-edge-smoke.sh script, assert_redirect_target(), assert_sso_vhost_contract(), assert_sso_vhost_enabled(), assert_vhost_forwarded_contract(), log(), main(), parse_args() (+6 more)
...
Cohesion: 0.44
Nodes (9): keycloak-sso-client-check.sh script, assert_client(), dashboard_checklist(), get_client_json(), kcadm_ready(), render_apply_plan(), render_inventory(), require_cmd() (+1 more)
...
Cohesion: 0.83
Nodes (3): install-mt5-remote-auth.sh script, run(), usage()
...
Cohesion: 0.83
Nodes (3): release.sh script, require_cmd(), usage()
...
Cohesion: 0.10
Nodes (58): Any, Path, Any, Path, Popen, Path, TarInfo, atomic_json() (+50 more)
...
Cohesion: 0.32
Nodes (19): Any, CompletedProcess, complete(), legacy_scanner_active(), legacy_transient_count(), live_pending_map(), load_state(), locked_state() (+11 more)
...
Cohesion: 0.21
Nodes (25): Any, CompletedProcess, Path, build_cgroup(), collect(), cpu_psi_avg10(), expected_cpu_max(), expected_cpu_units() (+17 more)
...
Cohesion: 0.83
Nodes (3): install-orphan-mcp-reaper.sh script, install_script(), install_systemd()

### Community 814 - "Community 814"
Cohesion: 0.67
Nodes (3): orphan-mcp-reaper.sh script, log(), MCP_PIDS
...
Cohesion: 0.62
Nodes (6): Path, atomic_write(), backup_targets(), discover(), main(), reconcile_bytes()
...
Cohesion: 0.04
Nodes (48): Alias-only rollback without recorded alias state, Applicable ASVS Categories, Architectural Responsibility Map, Architecture Patterns, Assumptions Log, Common Pitfalls, Concrete Manifest Guidance, Core (+40 more)
...
Cohesion: 0.07
Nodes (3): CompletedProcess, Path, Phase52BackupBTests
...
Cohesion: 0.15
Nodes (33): Any, Path, _ambiguous_projection(), atomic_json(), _checks_are_exact(), execute_live(), finalize_seal(), _gate_a_projection() (+25 more)
...
Cohesion: 0.21
Nodes (41): Any, ArgumentParser, Path, atomic_json(), canonical_existing(), capture(), compensate_install(), copy_exclusive() (+33 more)

### Community 866 - "Community 866"
Cohesion: 0.07
Nodes (17): Path, _load(), reviewed_bootstrap_fixture(), test_bounded_helpers_serialize_subreaper_and_restore_process_state(), test_executor_entrypoint_cleans_reviewed_tmpfs_when_context_load_fails(), test_executor_entrypoint_cleanup_failure_is_fail_closed_and_sanitized(), test_generator_cleans_ambiguous_create_side_effect(), test_generator_uses_isolated_hbbs_keypair_and_cleans_container() (+9 more)

### Community 867 - "Community 867"
Cohesion: 0.08
Nodes (46): _assert_keys(), _current_preflight(), DuplicateKeyError, _fabricated_meta_ipv4_rule(), _healthy_ops_observations(), _live_gate_module(), _load_strict(), _nft_json_rule() (+38 more)
...
Cohesion: 0.06
Nodes (33): Anti-Patterns, Architectural Patterns, Architecture Research, Blind active-active, Component Responsibilities, Data Flow, Evidence Boundaries, External Services (+25 more)

### Community 872 - "Community 872"
Cohesion: 0.19
Nodes (28): Any, datetime, _contains_sensitive(), _digest(), _duplicate_keys(), _emit(), _exact(), _invalid_constant() (+20 more)
...
Cohesion: 0.07
Nodes (29): Anti-Patterns and Conflicts, Benchmark, smoke, quality and soak scripts, Coverage, `docs/operations/local-ai-embeddings.md`, Error handling and evidence hygiene, File Classification, `inventory/hosts/horistic-srv.yaml`, `k8s/qwen-canary/kustomization.yaml` (+21 more)

### Community 875 - "Community 875"
Cohesion: 0.07
Nodes (29): 59-01-01, 59-01-02, 59-02-01, 59-02-02, 59-03-01, 59-03-02, 59-03-03, 59-04-01 (+21 more)
...
Cohesion: 0.19
Nodes (17): datetime, _external_probe_bundle(), _FakeClock, _hostname_probe_bundle(), _origin_policy(), _phase53_digest(), _probe_origin(), _raw() (+9 more)
...
Cohesion: 0.08
Nodes (25): Architecture Approach, Confidence Assessment, Critical Pitfalls, Executive Summary, Expected Features, Gaps to Address, Implications for Roadmap, Key Findings (+17 more)
...
Cohesion: 0.12
Nodes (7): Any, _FakeDnsEdgeBackend, _FakeEdgeBackend, _FakeWindowsRouteRunner, _set_barrier_observed(), test_rollback_recovers_backend_exception_after_partial_write(), test_windows_private_first_fallback_is_only_for_ssh_rc255()
...
Cohesion: 0.16
Nodes (58): Any, ArgumentParser, datetime, Namespace, Path, _adapter_coverage_valid(), adapters_ready(), _add_common_arguments() (+50 more)
...
Cohesion: 0.08
Nodes (24): D-01 — Target OCI exato, D-02 — Migração integral e arquitetura VCN, D-03 — Builder externo como hard gate, D-04 — Reserved public IP, D-05 — DRG e security bidirecionais, D-06 — OperationPlans e approvals, D-07 — Approvals históricos, D-08 — Gate por wave (+16 more)

### Community 950 - "Community 950"
Cohesion: 0.25
Nodes (7): Canary, promocao e rollback, Contratos de modelos e runtimes, Deferred Ideas, Dimensao e migracao dos indices, Phase 59: Qwen3 Embedding e Rerank Podman para k3s - Discussion Log, the agent's Discretion, Topologia k3s, recursos e governor

### Community 951 - "Community 951"
Cohesion: 0.46
Nodes (5): oci-admin-mcp-fleet-smoke.sh script, json_record(), probe_local(), probe_remote(), usage()

### Community 952 - "Community 952"
Cohesion: 0.09
Nodes (79): MonkeyPatch, Namespace, Path, ProbeContext, ProbeSpec, _args(), _assert_blocked(), _check() (+71 more)

### Community 953 - "Community 953"
Cohesion: 0.16
Nodes (36): _allowed_oci_pages(), _barrier_b(), _edge_applier_module(), _edge_transaction(), _edge_with_ip_proof(), _nft_template(), _phase53_edge_preflight(), _rendered_nft_candidate() (+28 more)
...
Cohesion: 0.17
Nodes (16): Path, _default_env_file(), _load_env(), Read-only access to DbOmniFleet customization registry., registry_rows_for_project(), _run_sql(), Any, Path (+8 more)
...
Cohesion: 0.22
Nodes (8): DNS dependency, Edge resolution, Official OCI references, Package Legitimacy Audit, Phase 54 Research — Implementation-ready findings, Resolved architecture, Runtime and validator gap, Validation Architecture
...
Cohesion: 0.33
Nodes (5): FixtureRequest, MonkeyPatch, _pin_immutable_phase52_report_observation_window(), Deterministic compatibility fixtures for immutable Phase 52 evidence tests., Keep static report semantics independent from expiry of committed live samples.
...
Cohesion: 0.20
Nodes (9): Canonical interface, Evidence schema, Independent review schemas, Independent verifier ownership, OperationPlan rules, Phase 54 — Fail-closed validation contract, Required plan gates, Status semantics (+1 more)
...
Cohesion: 0.11
Nodes (58): Any, Path, AdapterSpec, _answer_ttls(), _backup_command(), _backup_read(), _be3_normalized(), _be3_wg_read() (+50 more)

### Community 996 - "Community 996"
Cohesion: 0.40
Nodes (4): Done condition, Execution waves, Phase 54: Migração integral de rede OCI/DRG do Horistic para 10.31 e renumeração edge, Roadmap: Horistic OCI/DRG and Edge Readdress

### Community 997 - "Community 997"
Cohesion: 0.12
Nodes (24): AdapterSpec, Path, _be3_payload(), _dig(), _dns_outputs(), _evidence(), _install_matrix_mocks(), _spec() (+16 more)
...
Cohesion: 0.40
Nodes (4): External builder lineage, Immutable legacy hashes, Non-reuse rule, Phase 54 provenance and approval lineage

### Community 1019 - "Community 1019"
Cohesion: 0.29
Nodes (6): Current independent review gate, Current revision incorporation (pending independent verdict), Cycle log, HIGH findings the replan must close, Phase 54 Plan Convergence Review, Review protocol
...
Cohesion: 0.25
Nodes (7): Blockers, Current position, Decisions, Next action, Performance Metrics, Session, State: Horistic OCI/DRG and Edge Readdress
...
Cohesion: 0.29
Nodes (6): Bounded local matrix, Fixture matrix required in Wave 0, Per-plan Nyquist map, Phase 54 — Validation Strategy, Sign-off, Test infrastructure
...
Cohesion: 0.25
Nodes (17): _alias_variants(), _build_report(), _check_containers(), _check_endpoints(), _check_launchers(), _check_local_ports(), _check_pm2_boot_contract(), _check_remote_horistic_apache() (+9 more)
...
## Knowledge Gaps
- **7009 isolated node(s):** `mtime`, `ast_hash`, `semantic_hash`, `mtime`, `ast_hash` (+7004 more)
...
- **Why does `release_update()` connect `Community 2` to `Community 17`, `Community 955`, `Community 28`, `Community 22`?**
  _High betweenness centrality (0.009) - this node is a cross-community bridge._
- **Why does `Blocked` connect `Community 41` to `Community 955`?**
  _High betweenness centrality (0.007) - this node is a cross-community bridge._
- **Why does `isolated_restore_proof()` connect `Community 41` to `Community 800`, `Community 868`?**
...
- **What connects `mtime`, `ast_hash`, `semantic_hash` to the rest of the system?**
  _7432 weakly-connected nodes found - possible documentation gaps or missing edges._
- **Should `Community 0` be split into smaller, more focused modules?**
  _Cohesion score 0.002188183807439825 - nodes in this community are weakly interconnected._
