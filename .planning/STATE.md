...
**Last updated:** 2026-06-13 after M004 live repo/DB implementation and M005 preflight
...
|---|---|---|
| M004 | `codex/omni-fleet-control-plane-m004` | Live repo rollout, central `omni_fleet` DB, CLI dry-run commands, schema/config docs, pytest/offline/live validation, PgBouncer private endpoint guard |
