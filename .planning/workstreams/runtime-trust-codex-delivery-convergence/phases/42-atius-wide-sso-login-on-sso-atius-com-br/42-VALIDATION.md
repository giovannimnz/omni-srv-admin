...
| Secret hygiene | ripgrep denylist | `rg -n "SSO_TEST_PASSWORD|ADMIN_TEST_PASSWORD|client_secret|JWT_SECRET=.*[^<]|BEGIN (RSA|OPENSSH|EC) PRIVATE KEY" /home/ubuntu/GitHub/Atius-Capital/ats .planning/workstreams/runtime-trust-codex-delivery-convergence/phases/42-atius-wide-sso-login-on-sso-atius-com-br` |
