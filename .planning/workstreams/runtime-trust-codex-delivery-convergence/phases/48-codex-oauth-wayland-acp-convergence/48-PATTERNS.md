...
| `48-wayland-browser-lifecycle.md` | test | streaming | `docs/operations/wayland-managed-runtime.md` + `.planning/workstreams/runtime-trust-codex-delivery-convergence/phases/49-wayland-codex-headroom/49-VALIDATION.md` | exact |
...
**Tighter adjacent validation gate** (`.planning/workstreams/runtime-trust-codex-delivery-convergence/phases/49-wayland-codex-headroom/49-VALIDATION.md`, lines 5-9, 17-18):
```markdown
...
**Analogs:** `docs/operations/wayland-managed-runtime.md`, `docs/operations/WAYLAND-CODEX-HEADROOM-PLAN.md`, `.planning/workstreams/runtime-trust-codex-delivery-convergence/phases/49-wayland-codex-headroom/49-VALIDATION.md`
...
**Adjacent validation gate** (`.planning/workstreams/runtime-trust-codex-delivery-convergence/phases/49-wayland-codex-headroom/49-VALIDATION.md`, lines 11-13, 18-20, 31-32):
```markdown
...
### Stop Conditions
**Sources:** `docs/operations/WAYLAND-CODEX-HEADROOM-PLAN.md`, `.planning/workstreams/runtime-trust-codex-delivery-convergence/phases/49-wayland-codex-headroom/49-VALIDATION.md`
...
- `.planning/workstreams/runtime-trust-codex-delivery-convergence/phases/49-wayland-codex-headroom/49-VALIDATION.md`
