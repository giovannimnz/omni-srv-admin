...
- `docs/operations/ATIUS-INTERNAL-DNS-CANONICALIZATION-PLAN.md` is a useful runbook/reference, but phase execution order is now canonical only in `.planning/workstreams/runtime-trust-codex-delivery-convergence/phases/45-internal-dns-drg-canonicalization/`.
