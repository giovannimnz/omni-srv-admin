...
<task type="auto">
  ...
  <files>.planning/workstreams/runtime-trust-codex-delivery-convergence/phases/24-production-recovery-guard-ats-horistic/24-01-PLAN.md</files>
  ...
  <verify>
    <automated>node "$HOME/.Codex/get-shit-done/bin/gsd-tools.cjs" verify plan-structure .planning/workstreams/runtime-trust-codex-delivery-convergence/phases/24-production-recovery-guard-ats-horistic/24-01-PLAN.md</automated>
  </verify>
...
<output>
Create `.planning/workstreams/runtime-trust-codex-delivery-convergence/phases/24-production-recovery-guard-ats-horistic/24-SUMMARY.md`
