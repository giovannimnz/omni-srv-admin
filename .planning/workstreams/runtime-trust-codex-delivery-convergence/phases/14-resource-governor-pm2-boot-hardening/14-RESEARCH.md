...
- `modules/srv1-ops/systemd/` contem units versionadas para governor, slices e
  inviolable watchdog.
- `.planning/workstreams/runtime-trust-codex-delivery-convergence/phases/09-mission-guardian/` ja tratava `resource-governor` e
...
- RGP-01 a RGP-07 foram adicionados a `.planning/workstreams/runtime-trust-codex-delivery-convergence/REQUIREMENTS.md` e mapeados
  para Phase 14 / M006.
