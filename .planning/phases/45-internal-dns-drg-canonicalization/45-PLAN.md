...
files_modified:
  ...
  - .planning/phases/45-internal-dns-drg-canonicalization/*.md
...
<read_first>
- .planning/phases/45-internal-dns-drg-canonicalization/45-SESSION-INTAKE.md
- .planning/phases/45-internal-dns-drg-canonicalization/45-CROSS-PROJECT-DEPENDENCIES.md
- .planning/phases/45-internal-dns-drg-canonicalization/45-REVIEWS.md
- .planning/MILESTONES.md
- .planning/ROADMAP.md
- .planning/STATE.md
- .planning/REQUIREMENTS.md
...
- `.planning/phases/45-internal-dns-drg-canonicalization/45-SESSION-INTAKE.md`
- `.planning/phases/45-internal-dns-drg-canonicalization/45-S23-EDGE-VALIDATION.md`
- `.planning/phases/45-internal-dns-drg-canonicalization/45-CROSS-PROJECT-DEPENDENCIES.md`
- `.planning/phases/45-internal-dns-drg-canonicalization/45-REVIEWS.md`
