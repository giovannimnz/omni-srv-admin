...
<task type="auto">
  ...
  <files>.planning/phases/23-omni-fleet-governance-cockpit-sem-landscape/23-01-PLAN.md, .planning/phases/23-omni-fleet-governance-cockpit-sem-landscape/23-03-PLAN.md</files>
  ...
  <verify>
    <automated>grep -R "checkpoint:human-verify\\|TbUpdatePlans\\|command allowlist\\|sem SSH apply generico" .planning/phases/23-omni-fleet-governance-cockpit-sem-landscape/23-*-PLAN.md</automated>
  </verify>
...
<output>
Create `.planning/phases/23-omni-fleet-governance-cockpit-sem-landscape/23-SUMMARY.md` when all five plans complete.
</output>
