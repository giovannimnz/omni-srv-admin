...
- `.planning/phases/29-g18-controlled-upgrade-rdp-landscape-validation/29-04-RUNTIME-REPAIR.md` — runtime repair that joined `horistic-srv` to k3s as worker.

### Existing planning constraints
- `.planning/PROJECT.md` — milestone scope and global project constraints.
- `.planning/REQUIREMENTS.md` — EMB-01 through EMB-08.
- `.planning/ROADMAP.md` — Phase 41 goal, success criteria and refs.
