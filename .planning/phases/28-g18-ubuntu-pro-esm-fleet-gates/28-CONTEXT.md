...
- `.planning/STATE.md` records G18 operator next steps: authorize apt upgrade, validate Microsoft RDP post-upgrade on 3 SRVs, confirm Landscape SaaS UI with SRV-1/2/3 online.
- `.planning/ROADMAP.md` maps Phase 28 to requirements G18-01 and G18-02.
