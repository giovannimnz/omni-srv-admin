...
key-files:
  created:
    ...
    - .planning/phases/28-g18-ubuntu-pro-esm-fleet-gates/28-01-SUMMARY.md
  modified: []
...
- Generated `.planning/phases/28-g18-ubuntu-pro-esm-fleet-gates/28-01-G18-INVENTORY.md` without exposing account IDs, contract IDs, emails, token contents, hashes, API keys, or webhook secrets.
...
- `.planning/phases/28-g18-ubuntu-pro-esm-fleet-gates/28-01-G18-INVENTORY.md` - current redacted per-host G18 inventory.
- `.planning/phases/28-g18-ubuntu-pro-esm-fleet-gates/28-01-SUMMARY.md` - this summary.
...
python3 scripts/g18-pro-esm-inventory.py --hosts atius-srv-1,atius-srv-2,atius-srv-3 --output .planning/phases/28-g18-ubuntu-pro-esm-fleet-gates/28-01-G18-INVENTORY.md
test -s .planning/phases/28-g18-ubuntu-pro-esm-fleet-gates/28-01-G18-INVENTORY.md
rg -n "G18-01|G18-02|atius-srv-1|atius-srv-2|atius-srv-3|No live mutation executed" .planning/phases/28-g18-ubuntu-pro-esm-fleet-gates/28-01-G18-INVENTORY.md
rg -n "[A-Za-z0-9._%+-]+@[A-Za-z0-9.-]+\\.[A-Za-z]{2,}|\\b[ac]A[A-Za-z0-9_-]{12,}\\b|[A-Fa-f0-9]{64}" .planning/phases/28-g18-ubuntu-pro-esm-fleet-gates/28-01-G18-INVENTORY.md || true
```
