...
- `.planning/phases/36-keycloak-sso-and-coexistence/36-CONTEXT.md` — Phase 36 decisions, especially additive Keycloak and legacy SSO preservation.
- `.planning/phases/36-keycloak-sso-and-coexistence/36-01-SUMMARY.md` — Keycloak 26.6.3, `127.0.0.1:8180`, realm `atius`, FreeIPA federation, `phase36-smoke`.
- `.planning/phases/36-keycloak-sso-and-coexistence/36-VERIFICATION.md` — current OIDC and FreeIPA federation evidence.
