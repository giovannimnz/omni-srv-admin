...
4. Update this SUMMARY to `status: done` and link the resulting
   commit SHA in `.planning/STATE.md` and `.planning/ROADMAP.md`.
...
- `.planning/phases/16-m005-cloudflare-access/16-PLAN.md` (input)
- `.planning/phases/16-m005-cloudflare-access/16-SUMMARY.md` (this file)
