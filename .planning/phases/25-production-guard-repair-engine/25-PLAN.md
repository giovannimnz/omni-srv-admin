...
@.planning/phases/24-production-recovery-guard-ats-horistic/24-SUMMARY.md
...
<task type="auto">
  ...
  <files>.planning/phases/25-production-guard-repair-engine/25-01-PLAN.md</files>
  ...
  <verify>
    <automated>node "$HOME/.Codex/get-shit-done/bin/gsd-tools.cjs" verify plan-structure .planning/phases/25-production-guard-repair-engine/25-01-PLAN.md</automated>
  </verify>
...
<output>
Create `.planning/phases/25-production-guard-repair-engine/25-SUMMARY.md` when
