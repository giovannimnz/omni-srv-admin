...
<context>
@.planning/phases/26-production-guard-boot-login-protocol/26-CONTEXT.md
@.planning/phases/26-production-guard-boot-login-protocol/26-RESEARCH.md
@.planning/phases/26-production-guard-boot-login-protocol/26-VALIDATION.md
@.planning/phases/25-production-guard-repair-engine/25-SUMMARY.md
...
<task type="auto">
  ...
  <files>.planning/phases/26-production-guard-boot-login-protocol/26-01-PLAN.md</files>
  ...
  <verify>
    <automated>node "$HOME/.Codex/get-shit-done/bin/gsd-tools.cjs" verify plan-structure .planning/phases/26-production-guard-boot-login-protocol/26-01-PLAN.md</automated>
  </verify>
...
<output>
Create `.planning/phases/26-production-guard-boot-login-protocol/26-SUMMARY.md`
