# Graph Report - omni-srv-admin  (2026-07-24)

## Corpus Check
- 991 files · ~1,843,367 words
- Verdict: corpus is large enough that graph structure adds value.

## Summary
- 12371 nodes · 16789 edges · 1080 communities (935 shown, 145 thin omitted)
...
7. `State: Omni Srv Admin (omni-srv-admin)` - 41 edges
8. `run_preflight()` - 40 edges
9. `MonkeyPatch` - 37 edges
...
## Communities (1080 total, 145 thin omitted)
...
Cohesion: 0.05
Nodes (59): project_exists(), containers(), containers_mirrors(), deploy_cmd(), detect_cmd(), discover(), discover_check(), discover_heal() (+51 more)
...
Cohesion: 0.17
Nodes (30): _ahead_behind(), _as_bool(), _auto_push_enabled(), _branch(), _changed_since(), _configured_enabled(), _dirty_files(), _ensure_upstream_remote() (+22 more)
...
Cohesion: 0.20
Nodes (9): Community Hubs (Navigation), Corpus Check, God Nodes (most connected - your core abstractions), Graph Report - omni-srv-admin  (2026-07-24), Import Cycles, Knowledge Gaps, Suggested Questions, Summary (+1 more)
...
Cohesion: 0.12
Nodes (27): _current_preflight(), DuplicateKeyError, _fabricated_meta_ipv4_rule(), _healthy_ops_observations(), _live_gate_module(), _nft_json_rule(), _ops_api_module(), Raised when a JSON object contains a repeated member name. (+19 more)
...
Cohesion: 0.13
Nodes (23): _edge_transaction(), _FakeEdgeBackend, _nft_template(), _phase53_edge_preflight(), _rendered_nft_candidate(), test_barrier_a_typed_sources_are_fresh_a_only_and_topology_bound(), test_cas_stale_revision_blocks_before_any_nft_or_oci_mutation(), test_nft_backend_semantic_readback_is_independent_from_candidate_echo() (+15 more)
...
Cohesion: 0.09
Nodes (22): D-01 — Target OCI exato, D-02 — Migração integral e arquitetura VCN, D-03 — Builder externo como hard gate, D-04 — Reserved public IP, D-05 — DRG e security bidirecionais, D-06 — OperationPlans e approvals, D-07 — Approvals históricos, D-08 — Gate por wave (+14 more)
...
Cohesion: 0.18
Nodes (16): _allowed_oci_pages(), _load_strict(), _oci_rule(), test_contract_mutation_catalog_fails_closed(), test_contract_schema_files_parse_strictly(), test_contract_schema_preserves_phase_boundaries(), test_contract_schema_rejects_duplicate_json_keys(), test_listener_audit_rejects_extra_owner_and_digest_drift() (+8 more)
...
Cohesion: 0.25
Nodes (7): Canonical interface, Evidence schema, OperationPlan rules, Phase 54 — Fail-closed validation contract, Required plan gates, Status semantics, Wave lineage
...
Cohesion: 0.22
Nodes (10): load_project(), Carrega sync.yaml + deploy.yaml (se existir) de um projeto., Detecta novo release., run_detect(), _fork_repo_slug(), Resolve o slug do repo do fork.      Ordem:     1) cfg.fork_repo (se existir), Atualiza uma release existente no GitHub com notas em PT-BR geradas.      Use pa, Atalho: gera release notes com defaults e mostra (sem salvar). (+2 more)
...
Cohesion: 0.40
Nodes (4): Cycle log, HIGH findings the replan must close, Phase 54 Plan Convergence Review, Review protocol
...
Cohesion: 0.33
Nodes (5): Fixture matrix required in Wave 0, Per-plan Nyquist map, Phase 54 — Validation Strategy, Sign-off, Test infrastructure

## Knowledge Gaps
- **6966 isolated node(s):** `mtime`, `ast_hash`, `semantic_hash`, `mtime`, `ast_hash` (+6961 more)
...
- **Why does `release_update()` connect `Community 995` to `Community 953`, `Community 2`, `Community 28`, `Community 22`?**
  _High betweenness centrality (0.010) - this node is a cross-community bridge._
- **Why does `DuplicateKeyError` connect `Community 867` to `Community 22`?**
  _High betweenness centrality (0.007) - this node is a cross-community bridge._
- **Why does `Communities (1073 total, 139 thin omitted)` connect `Community 0` to `Community 155`?**
