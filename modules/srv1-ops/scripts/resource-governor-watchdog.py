...
CONSERVATIVE_OVERRIDE = {
    'RG_PROFILE_BUILDS_CPU_QUOTA': '125%',
    'RG_PROFILE_BUILDS_MEMORY_HIGH': '4G',
    'RG_PROFILE_BUILDS_MEMORY_MAX': '6G',
    'RG_PROFILE_BUILDS_MEMORY_SWAP_MAX': '512M',
    'RG_PROFILE_BUILDS_IO_READ_BW': '40M',
    'RG_PROFILE_BUILDS_IO_WRITE_BW': '20M',
    'RG_PROFILE_INTERACTIVE_CPU_QUOTA': '100%',
    'RG_PROFILE_INTERACTIVE_MEMORY_HIGH': '3G',
    'RG_PROFILE_INTERACTIVE_MEMORY_MAX': '4G',
    'RG_PROFILE_INTERACTIVE_MEMORY_SWAP_MAX': '256M',
    'RG_PROFILE_INTERACTIVE_IO_READ_BW': '30M',
    'RG_PROFILE_INTERACTIVE_IO_WRITE_BW': '15M',
    'RG_PROFILE_TRANSFERS_CPU_QUOTA': '75%',
    'RG_PROFILE_TRANSFERS_MEMORY_HIGH': '768M',
    'RG_PROFILE_TRANSFERS_MEMORY_MAX': '1536M',
    'RG_PROFILE_TRANSFERS_MEMORY_SWAP_MAX': '128M',
    'RG_PROFILE_TRANSFERS_IO_READ_BW': '35M',
    'RG_PROFILE_TRANSFERS_IO_WRITE_BW': '15M',
}
    ...
    while RUNNING:
        ...
        if reasons:
            ...
            if recovered and state.get('runtime_mode') == 'conservative' and runtime_path.exists():
                ...
                append_log(log_path, f'recovered disk={system_data["disk_pct"]}% swap={system_data["swap_pct"]}% mem={system_data["mem_available_mib"]}')
