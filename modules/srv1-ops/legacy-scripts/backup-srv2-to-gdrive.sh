...
# backup-srv1-to-gdrive.sh — Backup COMPLETO do SRV-2 para Google Drive
# ---------------------------------------------------------------
# Destino: giovanni-drive:ATIUS-SRV/SRV-2/Backup/snapshots/
...
BASE_PATH="ATIUS-SRV/SRV-2/Backup/snapshots"
...
# SRV-2 max write real ~108MB/s -> 50% por processo = 54MB/s.
...
log "=================================================="
log "BACKUP SRV-2 INÍCIO — snapshot=$DATE"
...
log "BACKUP SRV-2 FIM — exit=$EXIT_CODE"
log "=================================================="
exit $EXIT_CODE
