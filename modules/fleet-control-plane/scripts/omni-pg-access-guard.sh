...
iptables -A "$CHAIN" -i wg0 -p tcp -s 10.1.1.0/24 --dport 6432 -j RETURN
...
WG_OPEN_LINE="$(
  iptables -L INPUT --line-numbers -n \
    | awk '$4 == "ACCEPT" && $7 == "wg100" && $9 == "10.100.100.0/24" { print $1; exit } $4 == "ACCEPT" && $7 == "wg0" && $9 == "10.1.1.0/24" { print $1; exit }'
)"
