...
- `~/GitHub/obsidian-vault/ideaverse/60-LOGS/2026-06-15-camofox-hermes-notebooklm-bridge.md` (overview)
- `~/GitHub/obsidian-vault/ideaverse/60-LOGS/61-Incidents/2026-06-15-camofox-vnc-porta-colisao-e-log-permissao.md` (incident)
- `~/GitHub/obsidian-vault/ideaverse/60-LOGS/2026-06-15-firefox-cookies-para-camofox.md` (Firefox -> Camofox)
...
- O noVNC usa `resize=scale`: resolucao remota fixa `1366x768`, escala local ao tamanho da janela.
- O `server.js` deve ajustar a janela Camoufox para `1366x768` apos cada launch.
