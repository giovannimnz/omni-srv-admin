...
> Versionado no git junto com `sync.yaml`. CLI regenera com `fork-sync manuals regen aionui`.
...
| # | Nome | URL | Role |
|---|------|-----|------|
| 1 | `AionUi` | https://github.com/iOfficeAI/AionUi | primary |
...
- `start-aionui.sh`
- `HERMES.md`
- `/home/ubuntu/.hermes/hermes-agent/acp_adapter/session.py`
- `hermes_gateway_adapter/`
- `/home/ubuntu/.hermes/hermes-agent/agent/skill_commands.py`
...
```bash
fork-sync manuals regenerate aionui
```
