...
> Versionado no git junto com `sync.yaml`. CLI regenera com `fork-sync manuals regen gsd-2`.
...
| # | Nome | URL | Role |
|---|------|-----|------|
| 1 | `gsd-2` | https://github.com/gsd-build/gsd-2 | primary |
...
```bash
fork-sync manuals regenerate gsd-2
```
