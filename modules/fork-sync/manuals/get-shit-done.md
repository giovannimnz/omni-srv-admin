...
> Versionado no git junto com `sync.yaml`. CLI regenera com `fork-sync manuals regen get-shit-done`.

## 1. Visão Geral

- **Projeto:** `get-shit-done`
- **Display name:** `get-shit-done`
...
| # | Nome | URL | Role |
|---|------|-----|------|
| 1 | `get-shit-done` | https://github.com/gsd-build/get-shit-done | primary |
...
```bash
fork-sync manuals regenerate get-shit-done
```
