...
> Versionado no git junto com `sync.yaml`. CLI regenera com `fork-sync manuals regen bruno`.
...
| # | Nome | URL | Role |
|---|------|-----|------|
| 1 | `bruno` | https://github.com/usebruno/bruno | primary |
...
```bash
fork-sync manuals regenerate bruno
```
