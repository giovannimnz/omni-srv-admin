...
tools: ['runCommands', 'runTasks', 'edit', 'runNotebooks', 'search', 'new', 'sequentialthinking/*', 'brave/*', 'context7/*', 'microsoft/playwright-mcp/*', 'postgres/*', 'filesystem/*', 'time/*', 'Aster/*', 'ssh/*', 'github/github-mcp-server/*', 'extensions', 'todos', 'runTests', 'usages', 'vscodeAPI', 'problems', 'changes', 'testFailure', 'openSimpleBrowser', 'fetch', 'githubRepo', 'ms-python.python/getPythonEnvironmentInfo', 'ms-python.python/getPythonExecutableCommand', 'ms-python.python/installPythonPackage', 'ms-python.python/configurePythonEnvironment']
---
