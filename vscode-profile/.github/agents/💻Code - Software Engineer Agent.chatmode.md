...
tools: ['vscode', 'execute', 'read', 'agent', 'edit', 'search', 'web', 'brave/*', 'context7/*', 'filesystem/*', 'github/*', 'playwright/*', 'postgres/*', 'sequentialthinking/*', 'pylance-mcp-server/*', 'vscode.mermaid-chat-features/renderMermaidDiagram', 'ms-azuretools.vscode-containers/containerToolsConfig', 'ms-python.python/getPythonEnvironmentInfo', 'ms-python.python/getPythonExecutableCommand', 'ms-python.python/installPythonPackage', 'ms-python.python/configurePythonEnvironment', 'todo']
---
