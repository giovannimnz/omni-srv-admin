...
- Guard iptables permite `27124/tcp` para `lo`, peers `wg100` dos servidores (`10.100.100.2` e `10.100.100.3`), edge clients live (`10.100.100.8` e `10.100.100.9`), compat legada temporaria (`10.100.100.5` e `10.100.100.6`) e as faixas OCI privadas `10.12.0.0/16`, `10.13.0.0/16`, `10.14.0.0/16` e `10.21.0.0/16`.
